...
fun main(args:Array<String>){
    ...
    //person1 과 person2는 서로 다른 인스턴스이므로 결과는 false
    println(person1 == person2)
    println(person1 === person2)

    //person1 과 person2가 동일한 인스턴스이므로 true
    println(person1 == person3)
    println(person1 === person3)

    //숫자 데이터의 경우는 ==는 저장하고 있는 데이터가 같은지 비교
    //===는 동일한 참조인지 비교
    //숫자 데이터를 생성자를 이용해서 생성하면 동일한 숫자라면 ==는 true를 리턴하고 ===는 false를 리턴
    ...
    //이 경우는 생성자를 호출하지 않았으므로 동일한 인스턴스이다
    val n4 = 500
    val n5 = 500
